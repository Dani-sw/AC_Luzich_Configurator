...
namespace AssettoCorsaSharedMemory
{
    ...
    public class AssettoCorsa
    {
        ...
        public virtual void OnGameStatusChanged(object sender,GameStatusEventArgs e)
        {
        ...
        public void OnGraphicsUpdated(GraphicsEventArgs e)
        {
            if (GraphicsUpdated != null)
            {
                ...
                if (gameStatus != e.Graphics.Status)
                {
                    ...
                    GameStatusChanged?.Invoke(this, new GameStatusEventArgs(gameStatus)); //fix 2025
